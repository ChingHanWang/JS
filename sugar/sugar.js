...
function findDifferent(numbers, excludedValue) {
  const uniqueElements = numbers.filter((e, index) => {
    return numbers.indexOf(e) === index && e !== excludedValue;
  });
  return uniqueElements;
}

console.log(findDifferent([1, 1, 1, 1, 3, 1, 1, 1], 1)); // 印出 3
